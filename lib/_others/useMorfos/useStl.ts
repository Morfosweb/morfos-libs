import useStl from '../styles';
import useStl2 from '../styles2';

const fns = {
  pad: (arg1: number, arg2?: number, arg3?: number, arg4?: number) => {
  ...
  marg: (arg1, arg2?: number, arg3?: number, arg4?: number) => {
    if (arg2 === undefined && arg3 === undefined && arg4 === undefined) {
      return {
        marginTop: arg1,
        marginRight: arg1,
